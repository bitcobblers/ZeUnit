...
{
    public static ZeResult<TType> Is<TType>(this TType actual, TType expected)
        where TType : IEquatable<TType>
    {
        return new ZeResult<TType>(actual).Is(expected);        
    }

    public static ZeResult<TType> Is<TType>(this ZeResult<TType> result, TType expected)
    {
