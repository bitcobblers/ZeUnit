...
Jump into the [Getting Started](/) guide to follow along on your local computer.
</Notes>
...
<Notes>
The example above explicitly defines the lifecycle by inheriting form the `TransientSuite` class, this the default behavior for classes that don't inherit a Suite class.
</Notes>
